...
import com.ryg.chapter_2.provider.ProviderActivity;
    ...
    private void persistToFile() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                File dir = new File(MyConstants.getCachePath(MainActivity.this));
                if (!dir.exists()) {
                    dir.mkdirs();
                }
                File cachedFile = new File(MyConstants.getCacheFilePath(MainActivity.this));
